...
def train_transformer(training_config):
    ...
    if training_config['learning_rule'] == 'aba1':
        save_file_name += '_aba1'    
    if training_config['learning_rule'] == 'aba2':
        save_file_name += '_aba2'
    if training_config['learning_rule'] == 'aba3':
        save_file_name += '_aba3'
    if training_config['learning_rule'] == 'aba4':
        save_file_name += '_aba4'
